...
.. include:: /_shared/pironman5/install_to_sd_rpi.rst
...
#. Click **OS**.
   ...
   * Scroll down and select **Misc utility images**.
     ...
     .. image:: /_shared/pironman5/img/nvme_misc.png
        :width: 90%

   * Select **Bootloader (Pi 5 family)**.

     .. image:: /_shared/pironman5/img/nvme_bootloader.png
        :width: 90%

   * Choose **NVMe/USB Boot** to set the boot order, then click **NEXT**.

     .. image:: /_shared/pironman5/img/nvme_boot.png
        :width: 90%
...
#. Review the settings and click **WRITE** to start.
   ...
   .. image:: /_shared/pironman5/img/nvme_write.png
      :width: 90%
...
#. Wait until **Write complete!** appears, then safely remove the storage device.
   ...
   .. image:: /_shared/pironman5/img/nvme_finish.png
      :width: 90%
...
4. In the **Storage** section, select your **NVMe SSD**. 
   ...
   .. image:: /_shared/pironman5/img/nvme_storage.png
      :width: 90%
