...
#. Go to the **OS** section, scroll to the bottom, and select **Use custom**.
   ...
   .. image:: /_shared/pironman5/img/imager_use_custom.png
      :width: 90%

#. Select the **Umbrel OS image file** you downloaded and extracted earlier, then click **Open**.

   .. image:: /_shared/pironman5/img/umbrel_choose_umbrel.png
       :width: 600
       :align: center

#. Click **Next** to continue.

   .. image:: /_shared/pironman5/img/imager_custom_next.png
      :width: 90%
...
#. Review all settings carefully, then click **WRITE**.
   ...
   .. image:: /_shared/pironman5/img/imager_write_umbrel.png
      :width: 90%
