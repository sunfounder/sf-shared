# CLAUDE.md - SunFounder Shared Documentation (Spanish)
...
## Language Role
This `sf-shared-es` repo is the **Spanish translation**. Must stay in sync with `sf-shared-en` for file structure, anchors, and conditional tags. Content in Spanish; structural elements identical to EN.
...
### Community Note
Spanish: "¡Hola, bienvenido a la comunidad de entusiastas de SunFounder Raspberry Pi & Arduino & ESP32 en Facebook! Sumérgete más en Raspberry Pi, Arduino y ESP32 con otros entusiastas."
